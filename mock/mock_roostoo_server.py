...
This file is a self-contained copy placed under /mock so teammates can run the
mock + simulator from a single folder without touching the original scripts/.
"""
import argparse
import json
import random
